...
export const processList = [
    {label: "1. Concept Discussion", desc: "We collaborate with you to understand your vision and the story you want to tell."},
    {label: "2. Sound Design", desc: "Our team crafts unique soundscapes and effects to bring your project to life."},
    {label: "3. Feedback & Revisions", desc: " We value your input to fine-tune the sound design until it meets your expectations."},
    {label: "4. Final Delivery", desc: "Delivering the final sound assets in the desired format and quality."},
]